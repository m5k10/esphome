...
const char *esp_gap_ble_cb_event_to_string(esp_gap_ble_cb_event_t evt) {
  switch (evt) {
    ...
    case ESP_GAP_BLE_SC_OOB_REQ_EVT:
      return "ESP_GAP_BLE_SC_OOB_REQ_EVT";
    case ESP_GAP_BLE_SC_CR_LOC_OOB_EVT:
      return "ESP_GAP_BLE_SC_CR_LOC_OOB_EVT";
    case ESP_GAP_BLE_GET_DEV_NAME_COMPLETE_EVT:
      return "ESP_GAP_BLE_GET_DEV_NAME_COMPLETE_EVT";
    case ESP_GAP_BLE_PERIODIC_ADV_RECV_ENABLE_COMPLETE_EVT:
      return "ESP_GAP_BLE_PERIODIC_ADV_RECV_ENABLE_COMPLETE_EVT";
    case ESP_GAP_BLE_PERIODIC_ADV_SYNC_TRANS_COMPLETE_EVT:
      return "ESP_GAP_BLE_PERIODIC_ADV_SYNC_TRANS_COMPLETE_EVT";
    case ESP_GAP_BLE_PERIODIC_ADV_SET_INFO_TRANS_COMPLETE_EVT:
      return "ESP_GAP_BLE_PERIODIC_ADV_SET_INFO_TRANS_COMPLETE_EVT";
    case ESP_GAP_BLE_SET_PAST_PARAMS_COMPLETE_EVT:
      return "ESP_GAP_BLE_SET_PAST_PARAMS_COMPLETE_EVT";
    case ESP_GAP_BLE_PERIODIC_ADV_SYNC_TRANS_RECV_EVT:
      return "ESP_GAP_BLE_PERIODIC_ADV_SYNC_TRANS_RECV_EVT";
    case ESP_GAP_BLE_DTM_TEST_UPDATE_EVT:
      return "ESP_GAP_BLE_DTM_TEST_UPDATE_EVT";
    case ESP_GAP_BLE_ADV_CLEAR_COMPLETE_EVT:
      return "ESP_GAP_BLE_ADV_CLEAR_COMPLETE_EVT";
    case ESP_GAP_BLE_SET_RPA_TIMEOUT_COMPLETE_EVT:
      return "ESP_GAP_BLE_SET_RPA_TIMEOUT_COMPLETE_EVT";
    case ESP_GAP_BLE_ADD_DEV_TO_RESOLVING_LIST_COMPLETE_EVT:
      return "ESP_GAP_BLE_ADD_DEV_TO_RESOLVING_LIST_COMPLETE_EVT";
    case ESP_GAP_BLE_VENDOR_CMD_COMPLETE_EVT:
      return "ESP_GAP_BLE_VENDOR_CMD_COMPLETE_EVT";
    case ESP_GAP_BLE_SET_PRIVACY_MODE_COMPLETE_EVT:
      return "ESP_GAP_BLE_SET_PRIVACY_MODE_COMPLETE_EVT";
    case ESP_GAP_BLE_SET_CSA_SUPPORT_COMPLETE_EVT:
      return "ESP_GAP_BLE_SET_CSA_SUPPORT_COMPLETE_EVT";
    case ESP_GAP_BLE_EVT_MAX:
      return "ESP_GAP_BLE_EVT_MAX";
    default:
      return "ESP_GAP_BLE_UNKNOWN_EVT";
  }
}

void ESP32BLE::real_gap_event_handler_(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param) {
  ESP_LOGV(TAG, "(BLE) gap_event_handler2 - %s (handlers: %d)", esp_gap_ble_cb_event_to_string(event),
           this->gap_event_handlers_.size());
